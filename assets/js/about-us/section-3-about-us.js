document.addEventListener('DOMContentLoaded', function () {
    ...
    const link1title = document.querySelector('#section-3-about-us__link-1-title');
    const link1description = document.querySelector('#section-3-about-us__link-1-description');
    // Link 2 elements
    const link2shape = document.querySelector('#section-3-about-us__link-2-shape');
    const link2plus = document.querySelector('#section-3-about-us__link-2-plus');
    const link2title = document.querySelector('#section-3-about-us__link-2-title');
    const link2description = document.querySelector('#section-3-about-us__link-2-description');
    // Link 3 elements
    const link3shape = document.querySelector('#section-3-about-us__link-3-shape');
    const link3plus = document.querySelector('#section-3-about-us__link-3-plus');
    const link3title = document.querySelector('#section-3-about-us__link-3-title');
    const link3description = document.querySelector('#section-3-about-us__link-3-description');
    // Link 4 elements
    const link4shape = document.querySelector('#section-3-about-us__link-4-shape');
    const link4plus = document.querySelector('#section-3-about-us__link-4-plus');
    const link4title = document.querySelector('#section-3-about-us__link-4-title');
    const link4description = document.querySelector('#section-3-about-us__link-4-description');
    ...
    function captureInitialStyles() {
        ...
        const elements = {
            ...
            'section-3-about-us__link-1-title': link1title,
            'section-3-about-us__link-1-description': link1description,
            // Link 2
            'section-3-about-us__link-2-shape': link2shape,
            'section-3-about-us__link-2-plus': link2plus,
            'section-3-about-us__link-2-title': link2title,
            'section-3-about-us__link-2-description': link2description,
            // Link 3
            'section-3-about-us__link-3-shape': link3shape,
            'section-3-about-us__link-3-plus': link3plus,
            'section-3-about-us__link-3-title': link3title,
            'section-3-about-us__link-3-description': link3description,
            // Link 4
            'section-3-about-us__link-4-shape': link4shape,
            'section-3-about-us__link-4-plus': link4plus,
            'section-3-about-us__link-4-title': link4title,
            'section-3-about-us__link-4-description': link4description,
        };
    ...
    function section3AboutUsUnselect() {
    ...
    function move4() {
        if (link4shape) {
            link4shape.style.height = SELECTED_LINK_SHAPE_HEIGHT;
            link4shape.style.width = SELECTED_LINK_SHAPE_WIDTH;
        ...
        if (link4plus) {
            link4plus.style.visibility = SELECTED_LINK_PLUS_VISIBILITY;
            link4plus.style.width = SELECTED_LINK_PLUS_WIDTH;
        }

        if (link4title) {
            link4title.style.width = SELECTED_LINK_TITLE_WIDTH;
            link4title.style.top = SELECTED_LINK_TITLE_TOP;
            link4title.style.left = SELECTED_LINK_TITLE_LEFT;
            link4title.style.fontSize = SELECTED_LINK_TITLE_FONT_SIZE;
            link4title.style.lineHeight = SELECTED_LINK_TITLE_LINE_HEIGHT;
            link4title.style.fontWeight = SELECTED_LINK_TITLE_FONT_WEIGHT;
        }

        if (link4description) {
            link4description.style.top = PARAGRAPH_TOP;
            link4description.style.left = PARAGRAPH_LEFT;
        }
    ...
    window.section3AboutUsSelectLink = section3AboutUsSelectLink;
    window.section3AboutUsUnselect = section3AboutUsUnselect;
